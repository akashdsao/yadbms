...
/**
 * FrameHeader represents the metadata for a frame in the buffer pool.
 * It contains information such as the frame ID, page ID, pin count,
 * dirty status, and the actual data of the frame.
 */

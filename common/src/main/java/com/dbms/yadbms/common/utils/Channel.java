...
/**
 * A simple thread-safe channel implementation using a queue.
 * This class allows multiple producers to put elements into the channel
 * and multiple consumers to get elements from the channel.
 *
...
public class Channel<T> {
    ...
    /**
     * Puts an element into the channel.
     * If the channel is empty, it signals waiting consumers.
     *
    ...
    /**
     * Gets an element from the channel.
     * If the channel is empty, it waits until an element is available.
     *
